        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
          ...
          >
            ...
            <div className="w-full aspect-video bg-gray-200 rounded-xl overflow-hidden relative mt-auto flex items-center justify-center">
              ...
              <img src="/home/product-1.png" alt="TiLENE® Blue Mesh" className="w-full h-full object-cover" />
            </div>
          </div>
          ...
          >
            ...
            <div className="w-full aspect-video bg-gray-200 rounded-xl overflow-hidden relative mt-auto flex items-center justify-center">
              <img src="/home/product-2.jpg" alt="TiLENE® Blue Mesh" className="w-full h-full object-cover" />
            </div>
          </div>
          ...
          >
            ...
            <div className="w-full aspect-video bg-gray-200 rounded-xl overflow-hidden relative mt-auto flex items-center justify-center">
              <img src="/home/product-3.jpg" alt="TiLENE® Blue Mesh" className="w-full h-full object-cover" />
            </div>
          </div>
        </div>
      </Container>
